...
export const defaultColumns: Column[] = [
  ...
  { key: 'Email', label: 'Email', visible: true, editable: false, width: '200px', type: 'text' },
  { key: 'Telefonní číslo', label: 'Telefon', visible: true, editable: true, width: '140px', type: 'text' },
  { key: 'Adresa', label: 'Adresa', visible: true, editable: true, width: '200px', type: 'text' },
  ...
  { key: 'Typ produktu', label: 'Typ produktu', visible: false, editable: false, width: '140px', type: 'text' },
];